...
public class CommandTPAHere implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource source, CommandContext arguments) throws CommandException {
        ...
        tpRequestUser.getTpRequests().put(user, true);
        player.sendMessage(Texts.of(TextColors.AQUA, "Successfully requested a teleport to ", TextColors.WHITE, request.get().getName()));
        ...
        requestText.append(Texts.of(TextColors.AQUA, " has requested that you teleport to them."));
